...
module pwm_controller_configmap_pwm_0_0(resetn_o, sawtri_o, async_o, upd_peak_o, 
  upd_valley_o, acq_free_o, acq_max_o, acq_cmp_o, acq_half_o, acq_zero_o, en_snoop_o, data_i)
/* synthesis syn_black_box black_box_pad_pin="resetn_o,sawtri_o,async_o,upd_peak_o,upd_valley_o,acq_free_o,acq_max_o,acq_cmp_o,acq_half_o,acq_zero_o,en_snoop_o,data_i[31:0]" */;
  output resetn_o;
  output sawtri_o;
  output async_o;
  output upd_peak_o;
